    ...
    <div className=" flex justify-center h-[750px] ">
      <div className="flex items-center justify-center mb-32 ">
        ...
        <div className="absolute ">
          <button className="p-7 w-[250px] mr-20 bg-gray-400 rounded-full text-white font-semibold mt-8">
            Select Pdf file
          </button>
          <p className="text-sm text-center mr-14">
            or simply drag or drop files
          </p>
        </div>
