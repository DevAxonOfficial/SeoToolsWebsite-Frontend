...
const Page = () => {
  ...
  const renderContent = () => {
    if (selectedFiles.length === 0) {
      return <p className="ml-4">Pdf File Name</p>;
      ...
      <div className=" relative flex justify-around  mt-10 ">
        ...
        >
          <div className="">
            ...
            <p className=" text-center font-bold text-3xl">Remove Pages</p>
        ...
        <div className="absolute sm:mt-[400px] xm:mt-[350px]  ">
          <div className="flex justify-center items-center rounded-2xl py-4 xm:px-8 sm:px-28 lg:px-52 bg-[#FDF8E1]">
